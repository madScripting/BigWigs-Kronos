...
L:RegisterTranslations("enUS", function() return {
	...
	portwarn = "Teleport!",
	portdelaywarn = "Teleport CD up in 5 seconds!",
	portdelaywarn10 = "Teleport CD up in 10 seconds!",
	tpbartext = "Teleport CD",
	tpsoonbartext = "Teleport SOON!",
...
function module:OnEngage()
	if self.db.profile.teleport then
		self:Bar(L["tpbartext"], timer.teleport, icon.teleport)
		self:DelayedBar(timer.teleport - 0.1, L["tpsoonbartext"], timer.tpsoon, icon.teleport)
...
function module:Teleport()
	if self.db.profile.teleport then
		self:Message(L["portwarn"], "Attention", false, "Alarm")
		self:RemoveBar(L["tpbartext"])
		self:RemoveBar(L["tpsoonbartext"])
		self:Bar(L["tpbartext"], timer.teleport, icon.teleport)
		self:DelayedBar(timer.teleport - 0.1, L["tpsoonbartext"], timer.tpsoon, icon.teleport)
