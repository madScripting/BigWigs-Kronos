...
function module:TeleportToBalcony()
	...
	if self.db.profile.wave then
		self:IntervalBar(L["wave1bar"], timer.balconywave1[1], timer.balconywave1[2], icon.wave, true, "black")
		self:IntervalBar(L["wave2bar"], timer.balconywave2[1], timer.balconywave2[2], icon.wave, true, "black")
	end
...
function module:Blink()
	if self.db.profile.blink then
		...
		if playerClass ~= "PRIEST" then
			self:WarningSign(icon.blink, 0.7)
			self:Sound("Info")
		end
	end
	if playerClass == "PRIEST" then
...
function module:RoomAdds(phase)
	if phase == 1 then
		local wavecount = 1
		self:IntervalBar(L["roomaddsbar"]..wavecount, timer.room1wave1[1], timer.room1wave1[2], icon.roomadds, true, "black")
		wavecount = wavecount + 1
		self:DelayedIntervalBar(timer.room1wave1[1], L["roomaddsbar"]..wavecount, timer.room1wave2[1]-timer.room1wave1[1], timer.room1wave2[2]-timer.room1wave1[1], icon.roomadds, true, "black")
		wavecount = wavecount + 1
		self:DelayedIntervalBar(timer.room1wave2[1], L["roomaddsbar"]..wavecount, timer.room1wave3[1]-timer.room1wave2[1], timer.room1wave3[2]-timer.room1wave2[1], icon.roomadds, true, "black")
	elseif phase == 2 then
		local wavecount = 1
		self:IntervalBar(L["roomaddsbar"]..wavecount, timer.room2wave1[1], timer.room2wave1[2], icon.roomadds, true, "black")
		wavecount = wavecount + 1
		self:DelayedIntervalBar(timer.room2wave1[1], L["roomaddsbar"]..wavecount, timer.room2wave2[1]-timer.room2wave1[1], timer.room2wave2[2]-timer.room2wave1[1], icon.roomadds, true, "black")
		wavecount = wavecount + 1
		self:DelayedIntervalBar(timer.room2wave2[1], L["roomaddsbar"]..wavecount, timer.room2wave3[1]-timer.room2wave2[1], timer.room2wave3[2]-timer.room2wave2[1], icon.roomadds, true, "black")
		wavecount = wavecount + 1
		self:DelayedIntervalBar(timer.room2wave3[1], L["roomaddsbar"]..wavecount, timer.room2wave4[1]-timer.room2wave3[1], timer.room2wave4[2]-timer.room2wave3[1], icon.roomadds, true, "black")
	elseif phase == 3 then
		local wavecount = 1
		self:IntervalBar(L["roomaddsbar"]..wavecount, timer.room3wave1[1], timer.room3wave1[2], icon.roomadds, true, "black")
		wavecount = wavecount + 1
		self:DelayedIntervalBar(timer.room3wave1[1], L["roomaddsbar"]..wavecount, timer.room3wave2[1]-timer.room3wave1[1], timer.room3wave2[2]-timer.room3wave1[1], icon.roomadds, true, "black")
		wavecount = wavecount + 1
		self:DelayedIntervalBar(timer.room3wave2[1], L["roomaddsbar"]..wavecount, timer.room3wave3[1]-timer.room3wave2[1], timer.room3wave3[2]-timer.room3wave2[1], icon.roomadds, true, "black")
		wavecount = wavecount + 1
		self:DelayedIntervalBar(timer.room3wave3[1], L["roomaddsbar"]..wavecount, timer.room3wave4[1]-timer.room3wave3[1], timer.room3wave4[2]-timer.room3wave3[1], icon.roomadds, true, "black")
		wavecount = wavecount + 1
		self:DelayedIntervalBar(timer.room3wave4[1], L["roomaddsbar"]..wavecount, timer.room3wave5[1]-timer.room3wave4[1], timer.room3wave5[2]-timer.room3wave4[1], icon.roomadds, true, "black")
		wavecount = wavecount + 1
		self:DelayedIntervalBar(timer.room3wave5[1], L["roomaddsbar"]..wavecount, timer.room3wave6[1]-timer.room3wave5[1], timer.room3wave6[2]-timer.room3wave5[1], icon.roomadds, true, "black")
	end
end
